...
- [**Geth (bera-geth)**](https://geth.ethereum.org/): Official Go implementation of the Ethereum protocol.
- [**Reth (bera-reth)**](https://reth.rs/): Rust-based client focusing on performance and reliability.
