...
var regexMap = map[string]ogenregex.Regexp{
	"^0x[a-fA-F0-9]{192}$":    ogenregex.MustCompile("^0x[a-fA-F0-9]{192}$"),
	"^0x[a-fA-F0-9]{2,}$":     ogenregex.MustCompile("^0x[a-fA-F0-9]{2,}$"),
	"^0x[a-fA-F0-9]{262144}$": ogenregex.MustCompile("^0x[a-fA-F0-9]{262144}$"),
	"^0x[a-fA-F0-9]{40}$":     ogenregex.MustCompile("^0x[a-fA-F0-9]{40}$"),
	"^0x[a-fA-F0-9]{64}$":     ogenregex.MustCompile("^0x[a-fA-F0-9]{64}$"),
	"^0x[a-fA-F0-9]{8}$":      ogenregex.MustCompile("^0x[a-fA-F0-9]{8}$"),
	"^0x[a-fA-F0-9]{96}$":     ogenregex.MustCompile("^0x[a-fA-F0-9]{96}$"),
}
var (
