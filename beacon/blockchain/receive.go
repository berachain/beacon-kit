...
func (s *Service[
	...
	if err := s.verifyStateRoot(ctx, postState, beaconBlk, consensusTime, proposerAddress); err != nil {
		s.logger.Error(
...
func (s *Service[
	_, _, ConsensusBlockT, BeaconBlockT, _, _, BeaconStateT, _, _, _, _, _, _, _, _, _,
]) verifyStateRoot(
	ctx context.Context,
	st BeaconStateT,
	blk BeaconBlockT,
