...
// Hash: 965964cadd0c27e53050d332b71501ae117bf8451a7718170fb974b3188724c6
// Version: 0.1.3
package signing
...
func (f *ForkData) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	dst = ssz.WriteOffset(dst, offset)
	offset += len(f.GenesisValidatorsRoot)
...
func (f *ForkData) UnmarshalSSZ(buf []byte) error {
	...
	{
		buf = tail[o1:]
		copy(f.GenesisValidatorsRoot[:], buf)
	}
	return err
}
...
func (f *ForkData) SizeSSZ() (size int) {
	...
	// Field (1) 'GenesisValidatorsRoot'
	size += len(f.GenesisValidatorsRoot)
...
func (f *ForkData) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	...
	{
		elemIndx := hh.Index()
		byteLen := uint64(len(f.GenesisValidatorsRoot[:]))
		if byteLen > 0 {
			err = ssz.ErrIncorrectListSize
			return
		}
		hh.Append(f.GenesisValidatorsRoot[:])
		hh.MerkleizeWithMixin(elemIndx, byteLen, (0+31)/32)
	}
