...
// Hash: 0f4242e4d7ce70d304801d76ff0013fc8a6ea4c71e6e69cf0177239c929a8209
package types
...
func (b *BlobSidecars) UnmarshalSSZ(buf []byte) error {
	...
	{
		buf = tail[o0:]
		num, err := ssz.DivideInt2(len(buf), 131720, 6)
		if err != nil {
			return err
		}
		...
		for ii := 0; ii < num; ii++ {
			...
			if err = b.Sidecars[ii].UnmarshalSSZ(buf[ii*131720 : (ii+1)*131720]); err != nil {
				return err
			}
		}
	}
...
func (b *BlobSidecar) UnmarshalSSZ(buf []byte) error {
	...
	for ii := 0; ii < 17; ii++ {
		if cap(b.InclusionProof[ii]) == 0 {
			b.InclusionProof[ii] = make([]byte, 0, len(buf[131176:131720][ii*32:(ii+1)*32]))
		}
		b.InclusionProof[ii] = append(b.InclusionProof[ii], buf[131176:131720][ii*32:(ii+1)*32]...)
	}
