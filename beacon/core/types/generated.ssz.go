...
// Hash: 738033be77713d17bf8186d75f0f60b05238b3f6da81e9645de7ec762572d3b5
package types
...
func (r *Redirect) UnmarshalSSZ(buf []byte) error {
	...
	if cap(r.Credentials) == 0 {
		r.Credentials = make([]byte, 0, len(buf[4:36]))
	}
	r.Credentials = append(r.Credentials, buf[4:36]...)

	// Field (2) 'Amount'
	r.Amount = ssz.UnmarshallUint64(buf[36:44])
	...
	// Field (4) 'Index'
	r.Index = ssz.UnmarshallUint64(buf[48:56])
