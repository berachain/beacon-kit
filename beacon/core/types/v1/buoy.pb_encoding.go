...
// Hash: e6954d8ef90bff459635b9f2eb67479ff1dcd33f06ed305ac9fae6971570461a
package typesv1
...
// MarshalSSZ ssz marshals the BeaconBuoyDeneb object
func (b *BeaconBuoyDeneb) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(b)
}

// MarshalSSZTo ssz marshals the BeaconBuoyDeneb object to a target array
func (b *BeaconBuoyDeneb) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(76)
	...
	if b.Body == nil {
		b.Body = new(BeaconBuoyBodyDeneb)
	}
...
// UnmarshalSSZ ssz unmarshals the BeaconBuoyDeneb object
func (b *BeaconBuoyDeneb) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 76 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the BeaconBuoyDeneb object
func (b *BeaconBuoyDeneb) SizeSSZ() (size int) {
	size = 76
...
// HashTreeRoot ssz hashes the BeaconBuoyDeneb object
func (b *BeaconBuoyDeneb) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(b)
}

// HashTreeRootWith ssz hashes the BeaconBuoyDeneb object with a hasher
func (b *BeaconBuoyDeneb) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
...
// MarshalSSZ ssz marshals the BeaconBuoyBodyDeneb object
func (b *BeaconBuoyBodyDeneb) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(b)
}

// MarshalSSZTo ssz marshals the BeaconBuoyBodyDeneb object to a target array
func (b *BeaconBuoyBodyDeneb) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(140)
...
// UnmarshalSSZ ssz unmarshals the BeaconBuoyBodyDeneb object
func (b *BeaconBuoyBodyDeneb) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 140 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the BeaconBuoyBodyDeneb object
func (b *BeaconBuoyBodyDeneb) SizeSSZ() (size int) {
	size = 140
...
// HashTreeRoot ssz hashes the BeaconBuoyBodyDeneb object
func (b *BeaconBuoyBodyDeneb) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(b)
}

// HashTreeRootWith ssz hashes the BeaconBuoyBodyDeneb object with a hasher
func (b *BeaconBuoyBodyDeneb) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
