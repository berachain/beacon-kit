...
func (_m *LogContainer) Signature() common.Hash {
	ret := _m.Called()
...
// LogContainer_Signature_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Signature'
type LogContainer_Signature_Call struct {
	*mock.Call
}

// Signature is a helper method to define mock.On call
func (_e *LogContainer_Expecter) Signature() *LogContainer_Signature_Call {
	return &LogContainer_Signature_Call{Call: _e.mock.On("Signature")}
}

func (_c *LogContainer_Signature_Call) Run(run func()) *LogContainer_Signature_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *LogContainer_Signature_Call) Return(_a0 common.Hash) *LogContainer_Signature_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *LogContainer_Signature_Call) RunAndReturn(run func() common.Hash) *LogContainer_Signature_Call {
	_c.Call.Return(run)
	return _c
}
...
// LogContainer_Value_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Value'
type LogContainer_Value_Call struct {
	*mock.Call
}

// Value is a helper method to define mock.On call
func (_e *LogContainer_Expecter) Value() *LogContainer_Value_Call {
	return &LogContainer_Value_Call{Call: _e.mock.On("Value")}
}

func (_c *LogContainer_Value_Call) Run(run func()) *LogContainer_Value_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
