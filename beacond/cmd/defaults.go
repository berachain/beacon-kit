...
func DefaultComponents() []any {
	c := []any{
		components.ProvideABCIMiddleware[
			...
			*types.BlobSidecar, *types.BlobSidecars, *types.Deposit, *types.ExecutionPayloadHeader,
			*types.Genesis, *types.Logger,
		],
		components.ProvideAttributesFactory[
			*types.BeaconBlockHeader, *types.BeaconState, *types.BeaconStateMarshallable,
			*types.ExecutionPayloadHeader, *types.KVStore, *types.Logger,
		],
		components.ProvideAvailibilityStore[*types.BeaconBlockBody, *types.Logger],
		components.ProvideAvailabilityPruner[
			*types.AvailabilityStore, *types.BeaconBlock, *types.BeaconBlockBody,
			*types.BeaconBlockHeader, *types.BlobSidecars, *types.Logger,
		],
		components.ProvideBeaconDepositContract[
			*types.Deposit, *types.ExecutionPayload, *types.ExecutionPayloadHeader,
		],
		components.ProvideBlockStore[
			*types.BeaconBlock, *types.BeaconBlockBody, *types.BeaconBlockHeader, *types.Logger,
		],
		...
		components.ProvideBlobProcessor[
			*types.AvailabilityStore, *types.BeaconBlockBody, *types.BeaconBlockHeader,
		...
		components.ProvideChainService[
			*types.AvailabilityStore, *types.BeaconBlock, *types.BeaconBlockBody,
			*types.BeaconBlockHeader, *types.BeaconState, *types.BeaconStateMarshallable,
			*types.BlobSidecars, *types.BlockStore, *types.Deposit, *types.DepositStore,
			*types.ExecutionPayload, *types.ExecutionPayloadHeader, *types.Genesis,
			*types.KVStore, *types.Logger, *types.StorageBackend,
		],
		...
		components.ProvideDAService[
			*types.AvailabilityStore, *types.BeaconBlockBody, *types.BlobSidecar,
		...
		components.ProvideDepositService[
			*types.BeaconBlock, *types.BeaconBlockBody, *types.BeaconBlockHeader, *types.Deposit,
			*types.DepositContract, *types.DepositStore, *types.ExecutionPayload,
			*types.ExecutionPayloadHeader, *types.Logger,
		],
		components.ProvideDepositStore[*types.Deposit],
		components.ProvideDispatcher[
			*types.BeaconBlock, *types.BlobSidecars, *types.Genesis, *types.Logger,
		],
		...
		components.ProvideLocalBuilder[
			*types.BeaconBlockHeader, *types.BeaconState, *types.BeaconStateMarshallable,
			*types.ExecutionPayload, *types.ExecutionPayloadHeader, *types.KVStore, *types.Logger,
		],
		...
		components.ProvideServiceRegistry[
			*types.AvailabilityStore, *types.BeaconBlock, *types.BeaconBlockBody,
			*types.BeaconBlockHeader, *types.BlockStore, *types.BeaconState,
			*types.BeaconStateMarshallable, *types.BlobSidecar, *types.BlobSidecars,
			*types.Deposit, *types.DepositStore, *types.ExecutionPayload, *types.ExecutionPayloadHeader,
			*types.Genesis, *types.KVStore, *types.Logger,
			types.NodeAPIContext,
		],
		...
		components.ProvideStateProcessor[
			*types.BeaconBlock, *types.BeaconBlockBody, *types.BeaconBlockHeader,
			*types.BeaconState, *types.BeaconStateMarshallable, *types.Deposit, *types.ExecutionPayload,
			*types.ExecutionPayloadHeader, *types.KVStore,
		],
		components.ProvideKVStore[*types.BeaconBlockHeader, *types.ExecutionPayloadHeader],
		...
		components.ProvideValidatorService[
			*types.AvailabilityStore, *types.BeaconBlock, *types.BeaconBlockBody,
			*types.BeaconBlockHeader, *types.BeaconState, *types.BeaconStateMarshallable,
			*types.BlockStore, *types.BlobSidecars, *types.Deposit, *types.DepositStore,
			*types.ExecutionPayload, *types.ExecutionPayloadHeader, *types.KVStore, *types.Logger,
	...
	c = append(c,
		...
		components.ProvideNodeAPIBackend[
			*types.AvailabilityStore, *types.BeaconBlock, *types.BeaconBlockBody,
			*types.BeaconBlockHeader, *types.BlockStore, *types.BeaconState,
			*types.BeaconStateMarshallable, *types.BlobSidecars, *types.Deposit, *types.DepositStore,
			*types.ExecutionPayloadHeader, *types.KVStore, *types.CometBFTService, *types.StorageBackend,
		],
	)
	...
	c = append(c,
		components.ProvideNodeAPIHandlers[
			*types.BeaconBlockHeader, *types.BeaconState, *types.BeaconStateMarshallable,
			*types.ExecutionPayloadHeader, *types.KVStore, types.NodeAPIContext,
		],
		components.ProvideNodeAPIBeaconHandler[
			*types.BeaconBlockHeader, *types.BeaconState, *types.CometBFTService, types.NodeAPIContext,
		],
		...
		components.ProvideNodeAPIProofHandler[
			*types.BeaconBlockHeader, *types.BeaconState, *types.BeaconStateMarshallable,
			*types.ExecutionPayloadHeader, *types.KVStore, *types.CometBFTService, types.NodeAPIContext,
		],
	)
