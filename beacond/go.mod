...
require (
	...
	github.com/berachain/beacon-kit/mod/core v0.0.0-20240508035017-2fb637ea5f0a
...
require (
	...
	github.com/berachain/beacon-kit/mod/state-transition v0.0.0-00010101000000-000000000000 // indirect
