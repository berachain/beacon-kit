...
// validator files with BLS key support. It replaces the cosmos-sdk
// genutil helpers, which lost key-type selection when cometbft dropped
// it from privval.GenFilePV.
package privval
