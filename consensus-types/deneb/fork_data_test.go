...
func TestForkData_Serialization(t *testing.T) {
	...
	var unmarshalled deneb.ForkData
...
func TestNewForkData(t *testing.T) {
	...
	forkData := deneb.NewForkData(currentVersion, genesisValidatorsRoot)
...
func TestNew(t *testing.T) {
	...
	newForkData := deneb.NewForkData(currentVersion, genesisValidatorsRoot)
