...
func generateExecutionPayload() *deneb.ExecutionPayload {
	var (
...
func TestExecutionPayload_Serialization(t *testing.T) {
	...
	var unmarshalled deneb.ExecutionPayload
