...
func TestSignedBeaconBlockHeader_Serialization(t *testing.T) {
	t.Parallel()
	header := deneb.NewBeaconBlockHeader(
		math.Slot(100),
	...
	orig := &deneb.SignedBeaconBlockHeader{}
	...
	var unmarshalled deneb.SignedBeaconBlockHeader
...
func TestSignedBeaconBlockHeader_EmptySerialization(t *testing.T) {
	...
	require.Equal(t, deneb.BeaconBlockHeader{}, *unmarshalled.GetHeader())
...
func TestSignedBeaconBlockHeader_SizeSSZ(t *testing.T) {
	t.Parallel()
	sigHeader := deneb.NewSignedBeaconBlockHeader(
		deneb.NewBeaconBlockHeader(
			math.Slot(100),
			math.ValidatorIndex(200),
			common.Root{0xaa},
			common.Root{0xbb},
