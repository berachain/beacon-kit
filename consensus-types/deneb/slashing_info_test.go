...
func generateSlashingInfo() *deneb.SlashingInfo {
	return &deneb.SlashingInfo{
		Slot:  12345,
		Index: 67890,
	}
}
...
func TestSlashingInfo_MarshalSSZ_UnmarshalSSZ(t *testing.T) {
	...
	testCases := []struct {
		name     string
		data     *deneb.SlashingInfo
		expected *deneb.SlashingInfo
		err      error
	}{
		{
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			var unmarshalled deneb.SlashingInfo
