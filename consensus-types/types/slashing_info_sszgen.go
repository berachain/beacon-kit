...
// Hash: a3324b6c25a7a0adae23dcb5260af745726d5c3bd181949835ae0df711d2d84b
// Version: 0.1.3
package types
...
func (s *SlashingInfo) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (1) 'Index'
	dst = ssz.MarshalUint64(dst, uint64(s.Index))
...
func (s *SlashingInfo) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'Slot'
	s.Slot = math.Slot(ssz.UnmarshallUint64(buf[0:8]))

	// Field (1) 'Index'
	s.Index = math.U64(ssz.UnmarshallUint64(buf[8:16]))
