...
contract GetBytecodeScript is Script {
    function run() external {
        ...
        console.log(
            "Genesis Address: 0x4200000000000000000000000000000000000043"
        );
        ...
        console.log(
            "Genesis Address: 0x4200000000000000000000000000000000000042"
        );
        ...
        bytes4 distributeForSelector =
            SimplePoLDistributor.distributeFor.selector;
        bytes4 recordActivitySelector =
            ValidatorRegistry.recordValidatorActivity.selector;
        console.log("\n=== Function Selectors ===");
        console.log(
            "distributeFor selector:", vm.toString(distributeForSelector)
        );
        console.log(
            "recordValidatorActivity selector:",
            vm.toString(recordActivitySelector)
        );
    }
}
