...
var (
	...
	// ErrSlotNotRequested is returned by a by-range verify callback for in-range slots the requester does not need; the chunk is skipped
	// without penalizing the peer.
	ErrSlotNotRequested = errors.New("slot was not requested")
)
