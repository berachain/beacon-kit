...
// BlobStore is the read side of the availability store used to serve peers.
type BlobStore interface {
	// GetByIndex retrieves all raw SSZ-encoded sidecars for a given slot.
	GetByIndex(index uint64) ([][]byte, error)
}

// SidecarVerifier verifies sidecars against a trusted header and commitment list. Satisfied by *blob.Processor.
