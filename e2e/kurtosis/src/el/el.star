...
def get_el(plan, client_type, el_cl_data, jwt_file, el_service_name, network_params):
    if client_type == constants.EL_CLIENT_TYPE.reth:
        return reth.get_reth(plan, el_cl_data, jwt_file, el_service_name, network_params)