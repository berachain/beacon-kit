...
// Hash: e9cc16da7a53e2cbed78c724ed4d0aee22838e2f454f3855fefd5426f2160ad2
package enginetypes
...
func (e *ExecutableDataDeneb) UnmarshalSSZ(buf []byte) error {
	...
	// Field (15) 'BlobGasUsed'
	e.BlobGasUsed = ssz.UnmarshallUint64(buf[540:548])

	// Field (16) 'ExcessBlobGas'
	e.ExcessBlobGas = ssz.UnmarshallUint64(buf[548:556])
