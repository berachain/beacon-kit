...
// Hash: 253d29e6bea1c63e83fefadd814a29e4328e3cae9c2a3e8026529193c7f917da
package enginetypes
...
func (e *ExecutableDataDeneb) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if dst, err = e.BaseFeePerGas.MarshalSSZTo(dst); err != nil {
		return
	}
...
func (e *ExecutableDataDeneb) UnmarshalSSZ(buf []byte) error {
	...
	// Field (11) 'BaseFeePerGas'
	if err = e.BaseFeePerGas.UnmarshalSSZ(buf[440:440]); err != nil {
		return err
	}

	// Field (12) 'BlockHash'
	copy(e.BlockHash[:], buf[440:472])

	// Offset (13) 'Transactions'
	if o13 = ssz.ReadOffset(buf[472:476]); o13 > size || o10 > o13 {
		return ssz.ErrOffset
	}

	// Offset (14) 'Withdrawals'
	if o14 = ssz.ReadOffset(buf[476:480]); o14 > size || o13 > o14 {
		return ssz.ErrOffset
	}

	// Field (15) 'BlobGasUsed'
	e.BlobGasUsed = ssz.UnmarshallUint64(buf[480:488])

	// Field (16) 'ExcessBlobGas'
	e.ExcessBlobGas = ssz.UnmarshallUint64(buf[488:496])
...
func (e *ExecutableDataDeneb) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field (11) 'BaseFeePerGas'
	if err = e.BaseFeePerGas.HashTreeRootWith(hh); err != nil {
		return
	}
