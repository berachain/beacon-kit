...
// Hash: e5edc7d0d39061936428984599ca3f5ab83d58446d8073f011d0687bcdca4b74
package enginetypes
...
func (e *ExecutableDataDeneb) UnmarshalSSZ(buf []byte) error {
	...
	// Field (1) 'FeeRecipient'
	copy(e.FeeRecipient[:], buf[32:64])

	// Field (2) 'StateRoot'
	copy(e.StateRoot[:], buf[64:96])

	// Field (3) 'ReceiptsRoot'
	copy(e.ReceiptsRoot[:], buf[96:128])

	// Field (4) 'LogsBloom'
	if cap(e.LogsBloom) == 0 {
		e.LogsBloom = make([]byte, 0, len(buf[128:384]))
	}
	e.LogsBloom = append(e.LogsBloom, buf[128:384]...)

	// Field (5) 'Random'
	copy(e.Random[:], buf[384:416])

	// Field (6) 'Number'
	e.Number = ssz.UnmarshallUint64(buf[416:424])

	// Field (7) 'GasLimit'
	e.GasLimit = ssz.UnmarshallUint64(buf[424:432])

	// Field (8) 'GasUsed'
	e.GasUsed = ssz.UnmarshallUint64(buf[432:440])

	// Field (9) 'Timestamp'
	e.Timestamp = ssz.UnmarshallUint64(buf[440:448])

	// Offset (10) 'ExtraData'
	if o10 = ssz.ReadOffset(buf[448:452]); o10 > size {
	...
	if cap(e.BaseFeePerGas) == 0 {
		e.BaseFeePerGas = make([]byte, 0, len(buf[452:484]))
	}
	e.BaseFeePerGas = append(e.BaseFeePerGas, buf[452:484]...)

	// Field (12) 'BlockHash'
	copy(e.BlockHash[:], buf[484:516])

	// Offset (13) 'Transactions'
	if o13 = ssz.ReadOffset(buf[516:520]); o13 > size || o10 > o13 {
		return ssz.ErrOffset
	}

	// Offset (14) 'Withdrawals'
	if o14 = ssz.ReadOffset(buf[520:524]); o14 > size || o13 > o14 {
		return ssz.ErrOffset
	}

	// Field (15) 'BlobGasUsed'
	e.BlobGasUsed = ssz.UnmarshallUint64(buf[524:532])

	// Field (16) 'ExcessBlobGas'
	e.ExcessBlobGas = ssz.UnmarshallUint64(buf[532:540])
