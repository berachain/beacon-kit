...
import (
	...
	beratypes "github.com/berachain/beacon-kit/examples/berad/pkg/consensus-types"
	beracore "github.com/berachain/beacon-kit/examples/berad/pkg/state-transition"
	"github.com/berachain/beacon-kit/examples/berad/pkg/state-transition/state"
	beradb "github.com/berachain/beacon-kit/examples/berad/pkg/storage"
...
type (
	...
	StateProcessor = beracore.StateProcessor[
		*BeaconBlock,
		*BeaconBlockBody,
		*BeaconBlockHeader,
		*BeaconState,
...
type (
	...
	BeaconStateMarshallable = beratypes.BeaconState[
		*BeaconBlockHeader,
		*ExecutionPayloadHeader,
		*Fork,
		*Validator,
