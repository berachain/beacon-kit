...
func (sp *StateProcessor[
	_, _, _, BeaconStateT, _, DepositT, _, _, _, _, _, ValidatorT, _, _, _,
]) applyDeposit(
	st BeaconStateT,
	dep DepositT,
) error {
...
func (sp *StateProcessor[
	_, _, _, BeaconStateT, _, DepositT, _, _, _, ForkDataT, _, _, _, _, _,
]) createValidator(
	st BeaconStateT,
	dep DepositT,
) error {
...
//nolint:lll
func (sp *StateProcessor[
	_, BeaconBlockBodyT, _, BeaconStateT, _, _, _, _, _, _, _, ValidatorT, ValidatorsT, WithdrawalT, _,
]) expectedWithdrawals(st BeaconStateT) ([]WithdrawalT, error) {
	var (
		balance           math.Gwei
