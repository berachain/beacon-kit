...
def init_consensus_nodes():
    ...
    add_validator = "/usr/bin/beacond genesis add-genesis-deposit --home {} --beacon-kit.accept-tos".format("$BEACOND_HOME")
    collect_gentx = "/usr/bin/beacond genesis collect-genesis-deposits --home {}".format("$BEACOND_HOME")
