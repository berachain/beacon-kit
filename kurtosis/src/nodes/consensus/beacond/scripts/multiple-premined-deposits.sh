...
/usr/bin/beacond genesis add-premined-deposit --deposit-amount $DEPOSIT_AMOUNT --withdrawal-address $WITHDRAWAL_ADDRESS --home /tmp/config0/.beacond
...
for ((i=1; i<$NUM_VALS; i++)); do
    ...
    /usr/bin/beacond genesis add-premined-deposit --deposit-amount $DEPOSIT_AMOUNT --withdrawal-address $WITHDRAWAL_ADDRESS --home $BEACOND_HOME
