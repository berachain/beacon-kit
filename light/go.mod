module github.com/berachain/beacon-kit/light
...
replace (
	...
	github.com/berachain/beacon-kit/beacond => ../beacond
...
require (
	...
	cosmossdk.io/core v0.12.1-0.20240412212305-037cf98f7eea // indirect
