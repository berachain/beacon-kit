...
func (_m *StateDB) RemoveValidatorAtIndex(idx math.U64) error {
	ret := _m.Called(idx)
...
// StateDB_RemoveValidatorAtIndex_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'RemoveValidatorAtIndex'
type StateDB_RemoveValidatorAtIndex_Call struct {
	*mock.Call
}

// RemoveValidatorAtIndex is a helper method to define mock.On call
//   - idx math.U64
func (_e *StateDB_Expecter) RemoveValidatorAtIndex(idx interface{}) *StateDB_RemoveValidatorAtIndex_Call {
	return &StateDB_RemoveValidatorAtIndex_Call{Call: _e.mock.On("RemoveValidatorAtIndex", idx)}
}

func (_c *StateDB_RemoveValidatorAtIndex_Call) Run(run func(idx math.U64)) *StateDB_RemoveValidatorAtIndex_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(math.U64))
	})
	return _c
...
func (_c *StateDB_RemoveValidatorAtIndex_Call) Return(_a0 error) *StateDB_RemoveValidatorAtIndex_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *StateDB_RemoveValidatorAtIndex_Call) RunAndReturn(run func(math.U64) error) *StateDB_RemoveValidatorAtIndex_Call {
	_c.Call.Return(run)
	return _c
}
