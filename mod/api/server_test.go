...
func TestEndpoints(t *testing.T) {
	...
	tests := []struct {
		...
		{method: "GET", target: "/eth/v1/beacon/genesis", expectedStatus: http.StatusNotFound},
		{method: "GET", target: "/eth/v1/beacon/states/:state_id/root", expectedStatus: http.StatusNotFound},
		{method: "GET", target: "/eth/v1/beacon/states/:state_id/fork", expectedStatus: http.StatusNotFound},
		{method: "GET", target: "/eth/v1/beacon/states/:state_id/finality_checkpoints", expectedStatus: http.StatusNotFound},
		{method: "GET", target: "/eth/v1/beacon/states/:state_id/validators", expectedStatus: http.StatusNotFound},
		{method: "POST", target: "/eth/v1/beacon/states/:state_id/validators", expectedStatus: http.StatusNotFound},
		{method: "GET", target: "/eth/v1/beacon/states/:state_id/validators/:validator_id", expectedStatus: http.StatusNotFound},
		{method: "GET", target: "/eth/v1/beacon/states/:state_id/validators/validator_balances", expectedStatus: http.StatusNotFound},
		{method: "POST", target: "/eth/v1/beacon/states/:state_id/validators/validator_balances", expectedStatus: http.StatusNotFound},
		{method: "GET", target: "/eth/v1/beacon/states/:state_id/committees", expectedStatus: http.StatusNotFound},
		{method: "GET", target: "/eth/v1/beacon/states/:state_id/sync_committees", expectedStatus: http.StatusNotFound},
		{method: "GET", target: "/eth/v1/beacon/states/:state_id/randao", expectedStatus: http.StatusNotFound},
		{method: "GET", target: "/eth/v1/beacon/headers", expectedStatus: http.StatusNotFound},
		{method: "GET", target: "/eth/v1/beacon/headers/:block_id", expectedStatus: http.StatusNotFound},
		...
		{method: "GET", target: "/eth/v2/beacon/blocks/:block_id", expectedStatus: http.StatusNotFound},
		{method: "GET", target: "/eth/v1/beacon/blocks/:block_id/root", expectedStatus: http.StatusNotFound},
		{method: "GET", target: "/eth/v1/beacon/blocks/:block_id/attestations", expectedStatus: http.StatusNotFound},
		{method: "GET", target: "/eth/v1/beacon/blob_sidecars/:block_id", expectedStatus: http.StatusNotFound},
		{method: "POST", target: "/eth/v1/beacon/rewards/sync_committee/:block_id", expectedStatus: http.StatusNotFound},
		{method: "GET", target: "/eth/v1/beacon/deposit_snapshot", expectedStatus: http.StatusNotFound},
		{method: "GET", target: "/eth/v1/beacon/rewards/block/:block_id", expectedStatus: http.StatusNotFound},
		{method: "POST", target: "/eth/v1/beacon/rewards/attestation/:epoch", expectedStatus: http.StatusNotFound},
		{method: "GET", target: "/eth/v1/beacon/blinded_blocks/:block_id", expectedStatus: http.StatusNotFound},
		...
		{method: "GET", target: "/eth/v1/beacon/pool/attestations", expectedStatus: http.StatusNotFound},
		{method: "POST", target: "/eth/v1/beacon/pool/attestations", expectedStatus: http.StatusNotFound},
		...
		{method: "POST", target: "/eth/v1/beacon/pool/sync_committees", expectedStatus: http.StatusNotFound},
		{method: "GET", target: "/eth/v1/beacon/pool/voluntary_exits", expectedStatus: http.StatusNotFound},
		{method: "POST", target: "/eth/v1/beacon/pool/voluntary_exits", expectedStatus: http.StatusNotFound},
		{method: "GET", target: "/eth/v1/beacon/pool/bls_to_execution_changes", expectedStatus: http.StatusNotFound},
		{method: "POST", target: "/eth/v1/beacon/pool/bls_to_execution_changes", expectedStatus: http.StatusNotFound},
		...
		{method: "GET", target: "/eth/v1/config/spec", expectedStatus: http.StatusNotFound},
		...
		{method: "GET", target: "/eth/v1/events?topics=head&topics=proposer_slashing", expectedStatus: http.StatusNotFound},
		...
		{method: "GET", target: "/eth/v1/validator/duties/proposer/:epoch", expectedStatus: http.StatusNotFound},
