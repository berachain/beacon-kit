...
func (s *Service[
	_, BeaconBlockT, _, _, BeaconStateT, _, _, _, _, _, _, _, _, _, _, _, _, _,
]) sendPostBlockFCU(
	ctx context.Context,
	st BeaconStateT,
	blk BeaconBlockT,
...
func (s *Service[
	_, BeaconBlockT, _, _, BeaconStateT, _,
...
func (s *Service[
	_, BeaconBlockT, _, _, _, _, _, _, _,
	ExecutionPayloadHeaderT, _, _, PayloadAttributesT, _, _, _, _, _,
