...
// Hash: b8f6255a3df3880a20a5220954afecafff2d7abf26484961d68f7b1ba531ec76
// Version: 0.1.3
package deneb
...
func (b *BeaconState) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Offset (16) 'CurrentSyncCommittee'
	dst = ssz.WriteOffset(dst, offset)
	...
	// Field (16) 'CurrentSyncCommittee'
	if size := len(b.CurrentSyncCommittee); size > 1099511627776 {
		err = ssz.ErrListTooBigFn("BeaconState.CurrentSyncCommittee", size, 1099511627776)
		return
	}
	for ii := 0; ii < len(b.CurrentSyncCommittee); ii++ {
		dst = append(dst, b.CurrentSyncCommittee[ii][:]...)
	}
...
func (b *BeaconState) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o4, o5, o8, o9, o10, o11, o14, o16 uint64
	...
	// Offset (16) 'CurrentSyncCommittee'
	if o16 = ssz.ReadOffset(buf[300:304]); o16 > size || o14 > o16 {
		return ssz.ErrOffset
	}
	...
	{
		buf = tail[o16:]
		num, err := ssz.DivideInt2(len(buf), 48, 1099511627776)
		if err != nil {
			return err
		}
		b.CurrentSyncCommittee = make([]crypto.BLSPubkey, num)
		for ii := 0; ii < num; ii++ {
			copy(b.CurrentSyncCommittee[ii][:], buf[ii*48:(ii+1)*48])
		}
	}
	return err
}
...
func (b *BeaconState) SizeSSZ() (size int) {
	...
	// Field (16) 'CurrentSyncCommittee'
	size += len(b.CurrentSyncCommittee) * 48
...
func (b *BeaconState) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	...
	// Field (16) 'CurrentSyncCommittee'
	{
		...
		subIndx := hh.Index()
		for _, i := range b.CurrentSyncCommittee {
			hh.PutBytes(i[:])
		}
		numItems := uint64(len(b.CurrentSyncCommittee))
		hh.MerkleizeWithMixin(subIndx, numItems, 1099511627776)
	}
