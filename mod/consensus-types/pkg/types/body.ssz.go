...
// Hash: 9560a974d9e02c8a41c741b532f8c552fb3ef6b8323909846159af1886af1e70
// Version: 0.1.3
package types
...
func (b *BeaconBlockBodyDeneb) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if size := len(b.Attestations); size > 256 {
		err = ssz.ErrListTooBigFn("BeaconBlockBodyDeneb.Attestations", size, 256)
		return
	}
	...
	// Field (4) 'SlashingInfo'
	if size := len(b.SlashingInfo); size > 256 {
		err = ssz.ErrListTooBigFn("BeaconBlockBodyDeneb.SlashingInfo", size, 256)
		return
	}
