...
func TestBeaconBlockBodyDenebPlus_GetSetAttestations(t *testing.T) {
	body := generateBeaconBlockBodyDenebPlus()
	attestations := []*types.AttestationData{
		{
			Slot:  512,
	...
	body.SetAttestations(attestations)
	require.Equal(t, attestations, body.GetAttestations())
}

func TestBeaconBlockBodyDenebPlus_GetSetEth1Data(t *testing.T) {
	body := generateBeaconBlockBodyDenebPlus()
	eth1Data := &types.Eth1Data{
		DepositRoot: common.Root{
			0x11, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09,
			0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F, 0x11, 0x11, 0x12, 0x13,
			0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1A, 0x1B, 0x1C, 0x1D,
			0x1E, 0x10,
		},
		DepositCount: 1111,
		BlockHash: gethprimitives.ExecutionHash{
			0x02, 0x03, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09,
			0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F, 0x11, 0x11, 0x12, 0x13,
			0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1A, 0x1B, 0x1C, 0x1D,
			0x1E, 0x1c,
		},
...
func TestBeaconBlockBodyDenebPlus_GetSetSlashingInfo(t *testing.T) {
	body := generateBeaconBlockBodyDenebPlus()
	slashingInfo := []*types.SlashingInfo{
		{
			Slot:  512,
	...
	body.SetSlashingInfo(slashingInfo)
	require.Equal(t, slashingInfo, body.GetSlashingInfo())
}
