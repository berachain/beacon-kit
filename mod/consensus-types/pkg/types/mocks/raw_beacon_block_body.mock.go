...
func (_m *RawBeaconBlockBody) SizeSSZ(_a0 bool) uint32 {
	ret := _m.Called(_a0)
...
//   - _a0 bool
func (_e *RawBeaconBlockBody_Expecter) SizeSSZ(_a0 interface{}) *RawBeaconBlockBody_SizeSSZ_Call {
	return &RawBeaconBlockBody_SizeSSZ_Call{Call: _e.mock.On("SizeSSZ", _a0)}
}

func (_c *RawBeaconBlockBody_SizeSSZ_Call) Run(run func(_a0 bool)) *RawBeaconBlockBody_SizeSSZ_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(bool))
	})
	return _c
...
func (_c *RawBeaconBlockBody_SizeSSZ_Call) Return(_a0 uint32) *RawBeaconBlockBody_SizeSSZ_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *RawBeaconBlockBody_SizeSSZ_Call) RunAndReturn(run func(bool) uint32) *RawBeaconBlockBody_SizeSSZ_Call {
	_c.Call.Return(run)
	return _c
}
