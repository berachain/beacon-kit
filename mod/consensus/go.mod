...
replace (
	...
	cosmossdk.io/x/auth => cosmossdk.io/x/auth v0.0.0-20240628155326-d426a5db6775
	cosmossdk.io/x/consensus => cosmossdk.io/x/consensus v0.0.0-20240628155326-d426a5db6775
