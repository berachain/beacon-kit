...
// Hash: d247339a7c0584b7632c721abf1937323559980877b464ba59e4cc3865b06eb9
// Version: 0.1.3
package deneb
...
func (b *BeaconState) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if b.LatestBlockHeader == nil {
		b.LatestBlockHeader = new(beacon.BeaconBlockHeader)
	}
	...
	// Field (6) 'Eth1Data'
	if b.Eth1Data == nil {
		b.Eth1Data = new(beacon.Eth1Data)
	}
...
func (b *BeaconState) UnmarshalSSZ(buf []byte) error {
	...
	// Field (9) 'Validators'
	{
		...
		b.Validators = make([]*beacon.Validator, num)
		for ii := 0; ii < num; ii++ {
			if b.Validators[ii] == nil {
				b.Validators[ii] = new(beacon.Validator)
			}
