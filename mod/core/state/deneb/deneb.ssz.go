...
// Hash: 5d7d72b7035f63c6517e17cc46484f162424700cab2d7f8c2dc01ed14744f312
// Version: 0.1.3
package deneb
...
func (b *BeaconState) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o4, o5, o6, o8, o9, o10, o13 uint64
	...
	// Field (7) 'Eth1DepositIndex'
	b.Eth1DepositIndex = ssz.UnmarshallUint64(buf[180:188])

	// Offset (8) 'Validators'
	if o8 = ssz.ReadOffset(buf[188:192]); o8 > size || o6 > o8 {
		return ssz.ErrOffset
	}

	// Offset (9) 'Balances'
	if o9 = ssz.ReadOffset(buf[192:196]); o9 > size || o8 > o9 {
		return ssz.ErrOffset
	}
	...
	// Field (11) 'NextWithdrawalIndex'
	b.NextWithdrawalIndex = ssz.UnmarshallUint64(buf[200:208])

	// Field (12) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[208:216]))

	// Offset (13) 'Slashings'
	if o13 = ssz.ReadOffset(buf[216:220]); o13 > size || o10 > o13 {
		return ssz.ErrOffset
	}

	// Field (14) 'TotalSlashing'
	b.TotalSlashing = primitives.Gwei(ssz.UnmarshallUint64(buf[220:228]))
