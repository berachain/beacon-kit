...
// Hash: 2d5ee602519fbbc210586182d3364afa9daed9f03bf37367a8fb1af626644d8c
// Version: 0.1.3
package deneb
...
func (b *BeaconState) UnmarshalSSZ(buf []byte) error {
	...
	// Field (11) 'NextWithdrawalIndex'
	b.NextWithdrawalIndex = ssz.UnmarshallUint64(buf[268:276])

	// Field (12) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[276:284]))

	// Offset (13) 'Slashings'
	if o13 = ssz.ReadOffset(buf[284:288]); o13 > size || o10 > o13 {
		return ssz.ErrOffset
	}

	// Field (14) 'TotalSlashing'
	b.TotalSlashing = primitives.Gwei(ssz.UnmarshallUint64(buf[288:296]))
