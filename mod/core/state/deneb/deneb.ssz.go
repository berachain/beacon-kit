...
// Hash: b47c55b85094e7e487048856c6c94e3adbc9bac71babff01e938406c58f0230d
// Version: 0.1.3
package deneb
...
func (b *BeaconState) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if b.LatestBlockHeader == nil {
		b.LatestBlockHeader = new(consensus.BeaconBlockHeader)
	}
	...
	// Field (6) 'Eth1Data'
	if b.Eth1Data == nil {
		b.Eth1Data = new(consensus.Eth1Data)
	}
	...
	if b.LatestExecutionPayloadHeader == nil {
		b.LatestExecutionPayloadHeader = new(engineprimitives.ExecutionPayloadHeaderDeneb)
	}
...
func (b *BeaconState) UnmarshalSSZ(buf []byte) error {
	...
	// Field (9) 'Validators'
	{
		...
		b.Validators = make([]*consensus.Validator, num)
		for ii := 0; ii < num; ii++ {
			if b.Validators[ii] == nil {
				b.Validators[ii] = new(consensus.Validator)
			}
