...
// Hash: a2b521a7cefc641e864ee1f4eda4695bd950e7771fec9296a0770e6b787bbac1
// Version: 0.1.3
package deneb
...
func (b *BeaconState) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o4, o5, o9, o10, o11, o14 uint64
	...
	// Field (6) 'Eth1BlockHash'
	copy(b.Eth1BlockHash[:], buf[176:208])

	// Field (7) 'Eth1Data'
	if b.Eth1Data == nil {
		b.Eth1Data = new(primitives.Eth1Data)
	}
	if err = b.Eth1Data.UnmarshalSSZ(buf[208:280]); err != nil {
		return err
	}

	// Field (8) 'Eth1DepositIndex'
	b.Eth1DepositIndex = ssz.UnmarshallUint64(buf[280:288])

	// Offset (9) 'Validators'
	if o9 = ssz.ReadOffset(buf[288:292]); o9 > size || o5 > o9 {
		return ssz.ErrOffset
	}

	// Offset (10) 'Balances'
	if o10 = ssz.ReadOffset(buf[292:296]); o10 > size || o9 > o10 {
		return ssz.ErrOffset
	}

	// Offset (11) 'RandaoMixes'
	if o11 = ssz.ReadOffset(buf[296:300]); o11 > size || o10 > o11 {
		return ssz.ErrOffset
	}

	// Field (12) 'NextWithdrawalIndex'
	b.NextWithdrawalIndex = ssz.UnmarshallUint64(buf[300:308])

	// Field (13) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[308:316]))

	// Offset (14) 'Slashings'
	if o14 = ssz.ReadOffset(buf[316:320]); o14 > size || o11 > o14 {
		return ssz.ErrOffset
	}

	// Field (15) 'TotalSlashing'
	b.TotalSlashing = primitives.Gwei(ssz.UnmarshallUint64(buf[320:328]))
