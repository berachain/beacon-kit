...
// Hash: 4893e1bf657fa67e501c0b64e06d96b732fd64c70058c3e5e0dce70c6c523105
// Version: 0.1.3
package deneb
...
func (b *BeaconState) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o4, o5, o8, o9, o10, o13 uint64
	...
	// Field (7) 'Eth1DepositIndex'
	b.Eth1DepositIndex = ssz.UnmarshallUint64(buf[208:216])

	// Offset (8) 'Validators'
	if o8 = ssz.ReadOffset(buf[216:220]); o8 > size || o5 > o8 {
		return ssz.ErrOffset
	}
	...
	// Offset (10) 'RandaoMixes'
	if o10 = ssz.ReadOffset(buf[224:228]); o10 > size || o9 > o10 {
		return ssz.ErrOffset
	}

	// Field (11) 'NextWithdrawalIndex'
	b.NextWithdrawalIndex = ssz.UnmarshallUint64(buf[228:236])

	// Field (12) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[236:244]))

	// Offset (13) 'Slashings'
	if o13 = ssz.ReadOffset(buf[244:248]); o13 > size || o10 > o13 {
		return ssz.ErrOffset
	}

	// Field (14) 'TotalSlashing'
	b.TotalSlashing = primitives.Gwei(ssz.UnmarshallUint64(buf[248:256]))
