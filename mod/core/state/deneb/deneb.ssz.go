...
// Hash: 5e69aa5f8ea53a9d2d4a1d698b6ea0294a785b1249ad822ce6cf93176c4b624c
// Version: 0.1.3
package deneb
...
func (b *BeaconState) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (2) 'Fork'
	if b.Fork == nil {
		b.Fork = new(consensusprimitives.Fork)
	}
	...
	if b.LatestBlockHeader == nil {
		b.LatestBlockHeader = new(consensusprimitives.BeaconBlockHeader)
	}
	...
	// Field (7) 'Eth1Data'
	if b.Eth1Data == nil {
		b.Eth1Data = new(consensusprimitives.Eth1Data)
	}
