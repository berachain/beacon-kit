...
// Hash: 98c61b8f7d7179e7dfd7c377b944ec856b94b9a65047a821bd6b3f7a68719fcc
// Version: 0.1.3
package deneb
...
import (
	...
	ep "github.com/berachain/beacon-kit/mod/primitives-engine"
...
func (b *BeaconState) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if b.LatestExecutionPayload == nil {
		b.LatestExecutionPayload = new(ep.ExecutableDataDeneb)
	}
...
func (b *BeaconState) UnmarshalSSZ(buf []byte) error {
	...
	// Field (13) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[280:288]))
	...
	// Field (15) 'TotalSlashing'
	b.TotalSlashing = primitives.Gwei(ssz.UnmarshallUint64(buf[292:300]))
	...
	// Field (11) 'RandaoMixes'
	{
		...
		b.RandaoMixes = make([]primitives.Root, num)
		for ii := 0; ii < num; ii++ {
