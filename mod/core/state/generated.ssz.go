...
// Hash: e4b1a0bb82d6f1830cfcaa33c8cfe7b78a25ab91c3e889cc9b4e4eecc15cba33
// Version: 0.1.3
package state
...
func (b *BeaconStateDeneb) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o3, o4, o5, o7, o8, o9, o12 uint64
	...
	// Field (6) 'Eth1DepositIndex'
	b.Eth1DepositIndex = ssz.UnmarshallUint64(buf[164:172])

	// Offset (7) 'Validators'
	if o7 = ssz.ReadOffset(buf[172:176]); o7 > size || o5 > o7 {
		return ssz.ErrOffset
	}

	// Offset (8) 'Balances'
	if o8 = ssz.ReadOffset(buf[176:180]); o8 > size || o7 > o8 {
		return ssz.ErrOffset
	}

	// Offset (9) 'RandaoMixes'
	if o9 = ssz.ReadOffset(buf[180:184]); o9 > size || o8 > o9 {
		return ssz.ErrOffset
	}

	// Field (10) 'NextWithdrawalIndex'
	b.NextWithdrawalIndex = ssz.UnmarshallUint64(buf[184:192])

	// Field (11) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = ssz.UnmarshallUint64(buf[192:200])

	// Offset (12) 'Slashings'
	if o12 = ssz.ReadOffset(buf[200:204]); o12 > size || o9 > o12 {
		return ssz.ErrOffset
	}

	// Field (13) 'TotalSlashing'
	b.TotalSlashing = primitives.Gwei(ssz.UnmarshallUint64(buf[204:212]))
