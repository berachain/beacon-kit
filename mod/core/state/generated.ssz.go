...
// Hash: bfb0a09503dd9c1e7897e471f53e841d6d102ff50dbce357b8ec454cae463c55
// Version: 0.1.3
package state
...
func (b *BeaconStateDeneb) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	dst = ssz.MarshalUint64(dst, b.TotalSlashing)
...
func (b *BeaconStateDeneb) UnmarshalSSZ(buf []byte) error {
	...
	// Field (13) 'TotalSlashing'
	b.TotalSlashing = ssz.UnmarshallUint64(buf[232:240])
