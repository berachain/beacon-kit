...
// Hash: 156e73aecc02e10668b8bc3b598ae526bf7df2629acbd817298adee50e5018ef
// Version: 0.1.3
package types
...
func (b *BlobSidecars) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (0) 'Sidecars'
	if size := len(b.Sidecars); size > 8 {
		err = ssz.ErrListTooBigFn("BlobSidecars.Sidecars", size, 8)
		return
	}
...
func (b *BlobSidecars) UnmarshalSSZ(buf []byte) error {
	...
	{
		buf = tail[o0:]
		num, err := ssz.DivideInt2(len(buf), 131544, 8)
		if err != nil {
			return err
		}
