...
// Hash: 288d19dd6eeaaf3042afe1b1188f10b29a0db6df0210e49a7c20e3b1cec7cb1e
// Version: 0.1.3
package types
...
func (b *BlobSidecar) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (4) 'BlockHeadher'
	if b.BlockHeadher == nil {
		b.BlockHeadher = new(primitives.BlockHeader)
	}
	if dst, err = b.BlockHeadher.MarshalSSZTo(dst); err != nil {
		return
	}
...
func (b *BlobSidecar) UnmarshalSSZ(buf []byte) error {
	...
	if err = b.BlockHeadher.UnmarshalSSZ(buf[131176:131288]); err != nil {
		return err
	}
...
func (b *BlobSidecar) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	...
	if err = b.BlockHeadher.HashTreeRootWith(hh); err != nil {
		return
	}
