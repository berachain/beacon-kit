...
// Hash: 84356fb23d8b09911db678e59e0c126497fea284463efd3632f8b3766b7374cd
// Version: 0.1.3
package types
...
func (b *BlobSidecar) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if b.BlockHeader == nil {
		b.BlockHeader = new(primitives.BlockHeader)
	}
	if dst, err = b.BlockHeader.MarshalSSZTo(dst); err != nil {
		return
	}
...
func (b *BlobSidecar) UnmarshalSSZ(buf []byte) error {
	...
	if err = b.BlockHeader.UnmarshalSSZ(buf[131176:131288]); err != nil {
		return err
	}
...
func (b *BlobSidecar) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	...
	if err = b.BlockHeader.HashTreeRootWith(hh); err != nil {
		return
	}
