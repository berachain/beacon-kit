...
func (_m *BuiltExecutionPayloadEnv[ExecutionPayloadT]) GetValue() *math.U256 {
	ret := _m.Called()
...
func (_c *BuiltExecutionPayloadEnv_GetValue_Call[ExecutionPayloadT]) Return(_a0 *math.U256) *BuiltExecutionPayloadEnv_GetValue_Call[ExecutionPayloadT] {
	_c.Call.Return(_a0)
	return _c
}

func (_c *BuiltExecutionPayloadEnv_GetValue_Call[ExecutionPayloadT]) RunAndReturn(run func() *math.U256) *BuiltExecutionPayloadEnv_GetValue_Call[ExecutionPayloadT] {
	_c.Call.Return(run)
	return _c
}
