...
func (_m *BuiltExecutionPayloadEnv[ExecutionPayloadT]) GetValue() math.U256L {
	ret := _m.Called()
...
func (_c *BuiltExecutionPayloadEnv_GetValue_Call[ExecutionPayloadT]) Return(_a0 math.U256L) *BuiltExecutionPayloadEnv_GetValue_Call[ExecutionPayloadT] {
	_c.Call.Return(_a0)
	return _c
}

func (_c *BuiltExecutionPayloadEnv_GetValue_Call[ExecutionPayloadT]) RunAndReturn(run func() math.U256L) *BuiltExecutionPayloadEnv_GetValue_Call[ExecutionPayloadT] {
	_c.Call.Return(run)
	return _c
}
