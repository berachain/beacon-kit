...
//
// Solidity: function getDepositCount() view returns(bytes32)
func (_BeaconDepositContract *BeaconDepositContractCaller) GetDepositCount(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
...
//
// Solidity: function getDepositCount() view returns(bytes32)
func (_BeaconDepositContract *BeaconDepositContractSession) GetDepositCount() ([32]byte, error) {
...
//
// Solidity: function getDepositCount() view returns(bytes32)
func (_BeaconDepositContract *BeaconDepositContractCallerSession) GetDepositCount() ([32]byte, error) {
	return _BeaconDepositContract.Contract.GetDepositCount(&_BeaconDepositContract.CallOpts)
}
