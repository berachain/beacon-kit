...
// Hash: 25cd76937a6293fa942b6e6dcc2bd9b3686c780235d74deb4034ea702199cdcc
// Version: 0.1.3
package types
...
func (e *ExecutableDataDeneb) UnmarshalSSZ(buf []byte) error {
	...
	// Field (14) 'Withdrawals'
	{
		...
		e.Withdrawals = make([]*primitives.Withdrawal, num)
		for ii := 0; ii < num; ii++ {
			if e.Withdrawals[ii] == nil {
				e.Withdrawals[ii] = new(primitives.Withdrawal)
			}
