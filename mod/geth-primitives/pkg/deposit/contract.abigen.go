...
//
// Solidity: function initializeOwner(address _governance) returns()
func (_BeaconDepositContract *BeaconDepositContractTransactor) InitializeOwner(opts *bind.TransactOpts, _governance common.Address) (*types.Transaction, error) {
	return _BeaconDepositContract.contract.Transact(opts, "initializeOwner", _governance)
}

// InitializeOwner is a paid mutator transaction binding the contract method 0x8c5f36bb.
//
// Solidity: function initializeOwner(address _governance) returns()
func (_BeaconDepositContract *BeaconDepositContractSession) InitializeOwner(_governance common.Address) (*types.Transaction, error) {
	return _BeaconDepositContract.Contract.InitializeOwner(&_BeaconDepositContract.TransactOpts, _governance)
}

// InitializeOwner is a paid mutator transaction binding the contract method 0x8c5f36bb.
//
// Solidity: function initializeOwner(address _governance) returns()
func (_BeaconDepositContract *BeaconDepositContractTransactorSession) InitializeOwner(_governance common.Address) (*types.Transaction, error) {
	return _BeaconDepositContract.Contract.InitializeOwner(&_BeaconDepositContract.TransactOpts, _governance)
}
