...
func (_m *ExecutionPayloadBody) SizeSSZ() int {
	ret := _m.Called()
...
func (_e *ExecutionPayloadBody_Expecter) SizeSSZ() *ExecutionPayloadBody_SizeSSZ_Call {
	return &ExecutionPayloadBody_SizeSSZ_Call{Call: _e.mock.On("SizeSSZ")}
}

func (_c *ExecutionPayloadBody_SizeSSZ_Call) Run(run func()) *ExecutionPayloadBody_SizeSSZ_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *ExecutionPayloadBody_SizeSSZ_Call) Return(_a0 int) *ExecutionPayloadBody_SizeSSZ_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ExecutionPayloadBody_SizeSSZ_Call) RunAndReturn(run func() int) *ExecutionPayloadBody_SizeSSZ_Call {
	_c.Call.Return(run)
	return _c
}
