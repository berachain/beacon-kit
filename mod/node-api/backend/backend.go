...
// TODO: need to add state_id resolver; possible values are: "head" (canonical head in node's view),
// "genesis", "finalized", "justified", <slot>, <hex encoded stateRoot with 0x prefix>.
func New(getNewStateDB func(ctx context.Context, stateId string) StateDB) *Backend {
	return &Backend{
