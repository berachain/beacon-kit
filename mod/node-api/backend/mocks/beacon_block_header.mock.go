...
func (_m *BeaconBlockHeader[BeaconBlockHeaderT]) GetBodyRoot() bytes.B32 {
	ret := _m.Called()
...
func (_c *BeaconBlockHeader_GetBodyRoot_Call[BeaconBlockHeaderT]) Return(_a0 bytes.B32) *BeaconBlockHeader_GetBodyRoot_Call[BeaconBlockHeaderT] {
	_c.Call.Return(_a0)
	return _c
}

func (_c *BeaconBlockHeader_GetBodyRoot_Call[BeaconBlockHeaderT]) RunAndReturn(run func() bytes.B32) *BeaconBlockHeader_GetBodyRoot_Call[BeaconBlockHeaderT] {
	_c.Call.Return(run)
	return _c
}

// GetParentBlockRoot provides a mock function with given fields:
func (_m *BeaconBlockHeader[BeaconBlockHeaderT]) GetParentBlockRoot() bytes.B32 {
	ret := _m.Called()
...
func (_c *BeaconBlockHeader_GetParentBlockRoot_Call[BeaconBlockHeaderT]) Return(_a0 bytes.B32) *BeaconBlockHeader_GetParentBlockRoot_Call[BeaconBlockHeaderT] {
	_c.Call.Return(_a0)
	return _c
}

func (_c *BeaconBlockHeader_GetParentBlockRoot_Call[BeaconBlockHeaderT]) RunAndReturn(run func() bytes.B32) *BeaconBlockHeader_GetParentBlockRoot_Call[BeaconBlockHeaderT] {
	_c.Call.Return(run)
	return _c
}
...
func (_m *BeaconBlockHeader[BeaconBlockHeaderT]) GetStateRoot() bytes.B32 {
	ret := _m.Called()
...
func (_c *BeaconBlockHeader_GetStateRoot_Call[BeaconBlockHeaderT]) Return(_a0 bytes.B32) *BeaconBlockHeader_GetStateRoot_Call[BeaconBlockHeaderT] {
	_c.Call.Return(_a0)
	return _c
}

func (_c *BeaconBlockHeader_GetStateRoot_Call[BeaconBlockHeaderT]) RunAndReturn(run func() bytes.B32) *BeaconBlockHeader_GetStateRoot_Call[BeaconBlockHeaderT] {
	_c.Call.Return(run)
	return _c
}

// HashTreeRoot provides a mock function with given fields:
func (_m *BeaconBlockHeader[BeaconBlockHeaderT]) HashTreeRoot() ([32]byte, error) {
	ret := _m.Called()
...
func (_c *BeaconBlockHeader_HashTreeRoot_Call[BeaconBlockHeaderT]) Return(_a0 [32]byte, _a1 error) *BeaconBlockHeader_HashTreeRoot_Call[BeaconBlockHeaderT] {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *BeaconBlockHeader_HashTreeRoot_Call[BeaconBlockHeaderT]) RunAndReturn(run func() ([32]byte, error)) *BeaconBlockHeader_HashTreeRoot_Call[BeaconBlockHeaderT] {
	_c.Call.Return(run)
	return _c
}
...
func (_m *BeaconBlockHeader[BeaconBlockHeaderT]) New(slot math.U64, proposerIndex math.U64, parentBlockRoot bytes.B32, stateRoot bytes.B32, bodyRoot bytes.B32) BeaconBlockHeaderT {
	...
	if rf, ok := ret.Get(0).(func(math.U64, math.U64, bytes.B32, bytes.B32, bytes.B32) BeaconBlockHeaderT); ok {
...
func (_c *BeaconBlockHeader_New_Call[BeaconBlockHeaderT]) Run(run func(slot math.U64, proposerIndex math.U64, parentBlockRoot bytes.B32, stateRoot bytes.B32, bodyRoot bytes.B32)) *BeaconBlockHeader_New_Call[BeaconBlockHeaderT] {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *BeaconBlockHeader_New_Call[BeaconBlockHeaderT]) RunAndReturn(run func(math.U64, math.U64, bytes.B32, bytes.B32, bytes.B32) BeaconBlockHeaderT) *BeaconBlockHeader_New_Call[BeaconBlockHeaderT] {
	_c.Call.Return(run)
	return _c
}

// SetStateRoot provides a mock function with given fields: _a0
func (_m *BeaconBlockHeader[BeaconBlockHeaderT]) SetStateRoot(_a0 bytes.B32) {
	_m.Called(_a0)
}
...
func (_c *BeaconBlockHeader_SetStateRoot_Call[BeaconBlockHeaderT]) Run(run func(_a0 bytes.B32)) *BeaconBlockHeader_SetStateRoot_Call[BeaconBlockHeaderT] {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *BeaconBlockHeader_SetStateRoot_Call[BeaconBlockHeaderT]) RunAndReturn(run func(bytes.B32)) *BeaconBlockHeader_SetStateRoot_Call[BeaconBlockHeaderT] {
	_c.Call.Return(run)
	return _c
}
