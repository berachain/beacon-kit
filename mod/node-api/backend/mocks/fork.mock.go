...
type Fork[ForkT interface{}] struct {
	mock.Mock
}

type Fork_Expecter[ForkT interface{}] struct {
	mock *mock.Mock
}
...
type Fork_GetPreviousVersion_Call[ForkT interface{}] struct {
	*mock.Call
}
...
func NewFork[ForkT interface{}](t interface {
	mock.TestingT
	Cleanup(func())
}) *Fork[ForkT] {
	mock := &Fork[ForkT]{}
