...
func (_m *StateProcessor[BeaconStateT]) ProcessSlots(_a0 BeaconStateT, _a1 math.Slot) (transition.ValidatorUpdates, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(BeaconStateT, math.Slot) (transition.ValidatorUpdates, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(BeaconStateT, math.Slot) transition.ValidatorUpdates); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(BeaconStateT, math.Slot) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *StateProcessor_ProcessSlots_Call[BeaconStateT]) Run(run func(_a0 BeaconStateT, _a1 math.Slot)) *StateProcessor_ProcessSlots_Call[BeaconStateT] {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(BeaconStateT), args[1].(math.Slot))
	})
	return _c
}
...
func (_c *StateProcessor_ProcessSlots_Call[BeaconStateT]) RunAndReturn(run func(BeaconStateT, math.Slot) (transition.ValidatorUpdates, error)) *StateProcessor_ProcessSlots_Call[BeaconStateT] {
	_c.Call.Return(run)
	return _c
}
