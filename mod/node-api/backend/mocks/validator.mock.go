...
func (_m *Validator[WithdrawalCredentialsT]) GetWithdrawalCredentials() types.WithdrawalCredentials {
	ret := _m.Called()
...
func (_c *Validator_GetWithdrawalCredentials_Call[WithdrawalCredentialsT]) Return(_a0 types.WithdrawalCredentials) *Validator_GetWithdrawalCredentials_Call[WithdrawalCredentialsT] {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Validator_GetWithdrawalCredentials_Call[WithdrawalCredentialsT]) RunAndReturn(run func() types.WithdrawalCredentials) *Validator_GetWithdrawalCredentials_Call[WithdrawalCredentialsT] {
	_c.Call.Return(run)
	return _c
}
