...
type Validator[WithdrawalCredentialsT storage.WithdrawalCredentials] struct {
	mock.Mock
}

type Validator_Expecter[WithdrawalCredentialsT storage.WithdrawalCredentials] struct {
	mock *mock.Mock
}
...
type Validator_GetWithdrawalCredentials_Call[WithdrawalCredentialsT storage.WithdrawalCredentials] struct {
	*mock.Call
}
...
type Validator_IsFullyWithdrawable_Call[WithdrawalCredentialsT storage.WithdrawalCredentials] struct {
	*mock.Call
}
...
type Validator_IsPartiallyWithdrawable_Call[WithdrawalCredentialsT storage.WithdrawalCredentials] struct {
	*mock.Call
}
...
func NewValidator[WithdrawalCredentialsT storage.WithdrawalCredentials](t interface {
	mock.TestingT
	Cleanup(func())
