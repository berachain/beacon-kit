...
require (
	...
	github.com/berachain/beacon-kit/mod/da v0.0.0-20240603013748-9251c6e85587
...
require (
	...
	github.com/berachain/beacon-kit/mod/engine-primitives v0.0.0-20240508035017-2fb637ea5f0a // indirect
