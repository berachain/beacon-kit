...
// Hash: d6ae4943f275d8b2b10d9f281f192a96f32e36c8c3269af6639a27742e88b184
// Version: 0.1.3
package types
...
// MarshalSSZ ssz marshals the BeaconBlockValidatorPubkey object
func (b *BeaconBlockValidatorPubkey) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(b)
}

// MarshalSSZTo ssz marshals the BeaconBlockValidatorPubkey object to a target array
func (b *BeaconBlockValidatorPubkey) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(84)
...
// UnmarshalSSZ ssz unmarshals the BeaconBlockValidatorPubkey object
func (b *BeaconBlockValidatorPubkey) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 84 {
		return ssz.ErrSize
	...
	// Field (3) 'StateRoot'
	{
		buf = tail[o3:]
		if b.StateRoot == nil {
			b.StateRoot = new(BeaconStateValidatorPubkey)
		}
...
// SizeSSZ returns the ssz encoded size in bytes for the BeaconBlockValidatorPubkey object
func (b *BeaconBlockValidatorPubkey) SizeSSZ() (size int) {
	size = 84
...
// HashTreeRoot ssz hashes the BeaconBlockValidatorPubkey object
func (b *BeaconBlockValidatorPubkey) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(b)
}

// HashTreeRootWith ssz hashes the BeaconBlockValidatorPubkey object with a hasher
func (b *BeaconBlockValidatorPubkey) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	indx := hh.Index()
...
// GetTree ssz hashes the BeaconBlockValidatorPubkey object
func (b *BeaconBlockValidatorPubkey) GetTree() (*ssz.Node, error) {
	return ssz.ProofTree(b)
}

// MarshalSSZ ssz marshals the BeaconStateValidatorPubkey object
func (b *BeaconStateValidatorPubkey) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(b)
}

// MarshalSSZTo ssz marshals the BeaconStateValidatorPubkey object to a target array
func (b *BeaconStateValidatorPubkey) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(364)
	...
	if size := len(b.Validators); size > 1099511627776 {
		err = ssz.ErrListTooBigFn("BeaconStateValidatorPubkey.Validators", size, 1099511627776)
		return
	}
...
// UnmarshalSSZ ssz unmarshals the BeaconStateValidatorPubkey object
func (b *BeaconStateValidatorPubkey) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 364 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the BeaconStateValidatorPubkey object
func (b *BeaconStateValidatorPubkey) SizeSSZ() (size int) {
	size = 364
...
// HashTreeRoot ssz hashes the BeaconStateValidatorPubkey object
func (b *BeaconStateValidatorPubkey) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(b)
}

// HashTreeRootWith ssz hashes the BeaconStateValidatorPubkey object with a hasher
func (b *BeaconStateValidatorPubkey) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	indx := hh.Index()
...
// GetTree ssz hashes the BeaconStateValidatorPubkey object
func (b *BeaconStateValidatorPubkey) GetTree() (*ssz.Node, error) {
	return ssz.ProofTree(b)
}
