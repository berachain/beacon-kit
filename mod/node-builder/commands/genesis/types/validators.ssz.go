...
// Hash: 7bf2798f05fe82586aa873960ee0da64f9fc5622bb3a720f27b622a8c4cb190e
// Version: 0.1.3
package types
...
func (v *ValidatorsMarshaling) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'Validators'
	{
		...
		v.Validators = make([]*primitives.Validator, num)
		for ii := 0; ii < num; ii++ {
			if v.Validators[ii] == nil {
				v.Validators[ii] = new(primitives.Validator)
			}
