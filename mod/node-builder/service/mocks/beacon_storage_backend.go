...
import (
	...
	types "github.com/berachain/beacon-kit/mod/core/types"
)
...
func (_m *BeaconStorageBackend) AvailabilityStore(ctx context.Context) core.AvailabilityStore[types.ReadOnlyBeaconBlock] {
	ret := _m.Called(ctx)
	...
	var r0 core.AvailabilityStore[types.ReadOnlyBeaconBlock]
	if rf, ok := ret.Get(0).(func(context.Context) core.AvailabilityStore[types.ReadOnlyBeaconBlock]); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(core.AvailabilityStore[types.ReadOnlyBeaconBlock])
		}
	}
...
func (_c *BeaconStorageBackend_AvailabilityStore_Call) Return(_a0 core.AvailabilityStore[types.ReadOnlyBeaconBlock]) *BeaconStorageBackend_AvailabilityStore_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *BeaconStorageBackend_AvailabilityStore_Call) RunAndReturn(run func(context.Context) core.AvailabilityStore[types.ReadOnlyBeaconBlock]) *BeaconStorageBackend_AvailabilityStore_Call {
	_c.Call.Return(run)
	return _c
}
