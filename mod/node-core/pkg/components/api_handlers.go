...
func DefaultNodeAPIHandlers[
	...
	return []any{
		...
		ProvideNodeAPIBeaconHandler[
			BeaconBackendT, BeaconStateT, BeaconBlockHeaderT,
			ContextT, ForkT, ValidatorT,
		],
		...
		ProvideNodeAPIProofHandler[
			ContextT, BeaconBlockHeaderT, BeaconStateT,
			BeaconStateMarshallableT, Eth1DataT,
			ExecutionPayloadHeaderT, ForkT, KVStoreT,
			NodeAPIProofBackendT, ValidatorT, ValidatorsT,
