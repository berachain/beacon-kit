...
// BlobVerifierIn is the input for the BlobProcessor.
type BlobVerifierIn struct {
	depinject.In

	BlobProofVerifier KZGProofVerifier
	TelemetrySink     *metrics.TelemetrySink
}

// ProvideBlobVerifier is a function that provides the BlobVerifier to the
// depinject framework.
func ProvideBlobVerifier(in BlobVerifierIn) *BlobVerifier {
