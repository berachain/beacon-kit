...
import (
	...
	cmdlib "github.com/berachain/beacon-kit/mod/node/builder/pkg/commands/v2"
...
type AppInfo[T types.Tx] struct {
...
type NodeBuilder[T types.Tx] struct {
...
func NewNodeBuilder[T types.Tx]() *NodeBuilder[T] {
