...
// Hash: f7a55b73e8248bc17c64f79a877d1a4d1660535c57860d2e0daa1ef5e0fdbef7
// Version: 0.1.3
...
func (e *ExecutableDataDeneb) UnmarshalSSZ(buf []byte) error {
	...
	// Field (6) 'Number'
	e.Number = primitives.U64(ssz.UnmarshallUint64(buf[404:412]))

	// Field (7) 'GasLimit'
	e.GasLimit = primitives.U64(ssz.UnmarshallUint64(buf[412:420]))

	// Field (8) 'GasUsed'
	e.GasUsed = primitives.U64(ssz.UnmarshallUint64(buf[420:428]))

	// Field (9) 'Timestamp'
	e.Timestamp = primitives.U64(ssz.UnmarshallUint64(buf[428:436]))
	...
	// Field (15) 'BlobGasUsed'
	e.BlobGasUsed = primitives.U64(ssz.UnmarshallUint64(buf[512:520]))

	// Field (16) 'ExcessBlobGas'
	e.ExcessBlobGas = primitives.U64(ssz.UnmarshallUint64(buf[520:528]))
