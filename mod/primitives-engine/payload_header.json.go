...
func (e ExecutionPayloadHeaderDeneb) MarshalJSON() ([]byte, error) {
	type ExecutionPayloadHeaderDeneb struct {
		...
		TransactionsRoot primitives.Bytes32 `json:"transactionsRoot" ssz-size:"32"  gencodec:"required"`
		WithdrawalsRoot  primitives.Bytes32 `json:"withdrawalsRoot"  ssz-size:"32"`
