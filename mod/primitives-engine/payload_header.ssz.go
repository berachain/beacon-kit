...
// Hash: 920b219170fbacba8706b3a95c9ad81fcadd147cca118e820b7db997d941432e
// Version: 0.1.3
...
// MarshalSSZ ssz marshals the ExecutionHeaderDeneb object
func (e *ExecutionHeaderDeneb) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(e)
}

// MarshalSSZTo ssz marshals the ExecutionHeaderDeneb object to a target array
func (e *ExecutionHeaderDeneb) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(584)
	...
	if size := len(e.LogsBloom); size != 256 {
		err = ssz.ErrBytesLengthFn("ExecutionHeaderDeneb.LogsBloom", size, 256)
		return
	}
	...
	if size := len(e.ExtraData); size > 32 {
		err = ssz.ErrBytesLengthFn("ExecutionHeaderDeneb.ExtraData", size, 32)
		return
	}
...
// UnmarshalSSZ ssz unmarshals the ExecutionHeaderDeneb object
func (e *ExecutionHeaderDeneb) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 584 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the ExecutionHeaderDeneb object
func (e *ExecutionHeaderDeneb) SizeSSZ() (size int) {
	size = 584
...
// HashTreeRoot ssz hashes the ExecutionHeaderDeneb object
func (e *ExecutionHeaderDeneb) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(e)
}

// HashTreeRootWith ssz hashes the ExecutionHeaderDeneb object with a hasher
func (e *ExecutionHeaderDeneb) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	indx := hh.Index()
...
// GetTree ssz hashes the ExecutionHeaderDeneb object
func (e *ExecutionHeaderDeneb) GetTree() (*ssz.Node, error) {
