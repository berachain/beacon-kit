...
func TestU16_MarshalSSZ(t *testing.T) {
	tests := []struct {
		input    math.U16
		expected []byte
	}{
		{input: 1, expected: []byte{1, 0}},
		{input: 0, expected: []byte{0, 0}},
	}
...
func TestU16_HashTreeRoot(t *testing.T) {
	tests := []struct {
		input    math.U16
		expected [32]byte
	}{
...
func TestU16_NewFromSSZ(t *testing.T) {
	tests := []struct {
		...
		{name: "Valid1", input: []byte{1, 0}, expected: 1, err: false},
		{name: "Valid0", input: []byte{0, 0}, expected: 0, err: false},
