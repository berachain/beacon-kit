...
func TestVectorBasicSizeSSZ(t *testing.T) {
	...
	t.Run("empty vector", func(t *testing.T) {
		vector := ssz.VectorBasic[ssz.U64]{}
...
func TestVectorBasicHashTreeRoot(t *testing.T) {
	t.Run("uint8 vector", func(t *testing.T) {
		vector := ssz.VectorBasic[ssz.U8]{1, 2, 3, 4, 5}
	...
	t.Run("consistency", func(t *testing.T) {
		vector1 := ssz.VectorBasic[ssz.U8]{1, 2, 3, 4, 5}
		vector2 := ssz.VectorBasic[ssz.U8]{1, 2, 3, 4, 5}
...
func TestVectorBasicMarshalUnmarshal(t *testing.T) {
	t.Run("uint8 vector", func(t *testing.T) {
		original := ssz.VectorBasic[ssz.U8]{1, 2, 3, 4, 5}

		marshaled, err := original.MarshalSSZ()
		require.NoError(t, err)
		require.Len(t, marshaled, 5)

		unmarshaled, err := ssz.VectorBasic[ssz.U8]{}.NewFromSSZ(
			marshaled,
		)
		require.NoError(t, err)
	...
	t.Run("uint64 vector", func(t *testing.T) {
		original := ssz.VectorBasic[ssz.U64]{1, 2, 3, 4, 5}

		marshaled, err := original.MarshalSSZ()
		require.NoError(t, err)
		require.Len(t, marshaled, 40)

		unmarshaled, err := ssz.VectorBasic[ssz.U64]{}.NewFromSSZ(
			marshaled,
		)
		require.NoError(t, err)
	...
	t.Run("invalid buffer length", func(t *testing.T) {
		_, err := ssz.VectorBasic[ssz.U64]{}.NewFromSSZ(
			[]byte{1, 2, 3},
