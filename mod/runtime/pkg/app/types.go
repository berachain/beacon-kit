...
type BeaconState interface {
	// GetValidatorIndexByConsensusAddress returns the validator index by the
...
type SlotData[T, AttestationDataT, SlashingInfoT any] interface {
