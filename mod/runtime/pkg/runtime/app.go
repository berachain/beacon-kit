...
// App is a middleware between ABCI and the validator logic.
type App[
...
// NewApp creates a new instance of the Handler struct.
func NewApp[
	AttestationDataT AttestationData[AttestationDataT],
	AvailabilityStoreT any,
	BeaconBlockT BeaconBlock[BeaconBlockT],
	...
	GenesisT, SlashingInfoT, SlotDataT, StorageBackendT,
] {
	return &App[
		AttestationDataT, AvailabilityStoreT, BeaconBlockT,
		BeaconStateT, BlobSidecarsT, DepositT, ExecutionPayloadT,
		...
		logger:         logger,
		metrics:        newAppMetrics(telemetrySink),
