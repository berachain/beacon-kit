...
require (
	...
	github.com/berachain/beacon-kit/mod/cli v0.0.0-20240624003607-df94860f8eeb // indirect
	...
	github.com/berachain/beacon-kit/mod/primitives v0.0.0-20240624210933-3baa52ebb587 // indirect
