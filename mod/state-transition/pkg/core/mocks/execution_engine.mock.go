...
type ExecutionEngine[ExecutionPayloadT core.ExecutionPayload[ExecutionPayloadT, ExecutionPayloadHeaderT, WithdrawalsT], ExecutionPayloadHeaderT interface{}, WithdrawalsT core.Withdrawals] struct {
	mock.Mock
}

type ExecutionEngine_Expecter[ExecutionPayloadT core.ExecutionPayload[ExecutionPayloadT, ExecutionPayloadHeaderT, WithdrawalsT], ExecutionPayloadHeaderT interface{}, WithdrawalsT core.Withdrawals] struct {
	mock *mock.Mock
}
...
type ExecutionEngine_VerifyAndNotifyNewPayload_Call[ExecutionPayloadT core.ExecutionPayload[ExecutionPayloadT, ExecutionPayloadHeaderT, WithdrawalsT], ExecutionPayloadHeaderT interface{}, WithdrawalsT core.Withdrawals] struct {
	*mock.Call
}
...
func NewExecutionEngine[ExecutionPayloadT core.ExecutionPayload[ExecutionPayloadT, ExecutionPayloadHeaderT, WithdrawalsT], ExecutionPayloadHeaderT interface{}, WithdrawalsT core.Withdrawals](t interface {
	mock.TestingT
	Cleanup(func())
