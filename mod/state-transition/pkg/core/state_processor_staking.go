...
// local state.
func (sp *StateProcessor[
	_, _, _, BeaconStateT, _, _, DepositT, _, _, _, _, _, _, _, _, _,
]) processDeposits(
	st BeaconStateT,
	deposits []DepositT,
) error {
...
func (sp *StateProcessor[
	_, _, _, BeaconStateT, _, _, DepositT, _, _, _, _, _, _, ValidatorT, _, _,
]) applyDeposit(
	st BeaconStateT,
	dep DepositT,
) error {
...
func (sp *StateProcessor[
	_, _, _, BeaconStateT, _, _, DepositT, _, _, _, _, ForkDataT, _, _, _, _,
]) createValidator(
	st BeaconStateT,
	dep DepositT,
) error {
