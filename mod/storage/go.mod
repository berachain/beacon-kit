...
require (
	...
	github.com/berachain/beacon-kit/mod/consensus-types v0.0.0-20240518161709-f1474c8762fc
...
require (
	...
	github.com/berachain/beacon-kit/mod/primitives-engine v0.0.0-20240518161120-134a1180a2ee // indirect
