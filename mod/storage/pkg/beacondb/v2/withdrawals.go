...
func (s *StoreManager[
	...
	return s.nextWithdrawalIndex.Get()
}
...
func (s *StoreManager[
	...
	return s.nextWithdrawalIndex.Set(index)
}
...
func (s *StoreManager[
	...
	idx, err := s.nextWithdrawalValidatorIndex.Get()
...
func (s *StoreManager[
	...
	return s.nextWithdrawalValidatorIndex.Set(uint64(index))
}
