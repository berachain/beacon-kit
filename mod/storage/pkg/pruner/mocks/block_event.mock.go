...
func (_m *BlockEvent[BeaconBlockT]) ID() types.EventID {
	ret := _m.Called()
...
func (_c *BlockEvent_ID_Call[BeaconBlockT]) Return(_a0 types.EventID) *BlockEvent_ID_Call[BeaconBlockT] {
	_c.Call.Return(_a0)
	return _c
}

func (_c *BlockEvent_ID_Call[BeaconBlockT]) RunAndReturn(run func() types.EventID) *BlockEvent_ID_Call[BeaconBlockT] {
	_c.Call.Return(run)
	return _c
}
