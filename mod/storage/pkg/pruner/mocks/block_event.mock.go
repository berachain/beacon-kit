...
import (
	feed "github.com/berachain/beacon-kit/mod/primitives/pkg/feed"
...
func (_m *BlockEvent[BeaconBlockT]) Is(_a0 feed.EventID) bool {
	ret := _m.Called(_a0)
	...
	var r0 bool
	if rf, ok := ret.Get(0).(func(feed.EventID) bool); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Get(0).(bool)
	}
...
func (_c *BlockEvent_Is_Call[BeaconBlockT]) Run(run func(_a0 feed.EventID)) *BlockEvent_Is_Call[BeaconBlockT] {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(feed.EventID))
	})
	return _c
}
...
func (_c *BlockEvent_Is_Call[BeaconBlockT]) RunAndReturn(run func(feed.EventID) bool) *BlockEvent_Is_Call[BeaconBlockT] {
	_c.Call.Return(run)
	return _c
}
