...
func (h *Handler[ContextT, _]) GetStateValidators(
	c ContextT,
) (any, error) {
...
func (h *Handler[ContextT, _]) PostStateValidators(
	c ContextT,
) (any, error) {
...
func (h *Handler[ContextT, _]) GetStateValidator(
	c ContextT,
) (any, error) {
...
func (h *Handler[ContextT, _]) GetStateValidatorBalances(
	c ContextT,
) (any, error) {
...
func (h *Handler[ContextT, _]) PostStateValidatorBalances(
	c ContextT,
) (any, error) {
