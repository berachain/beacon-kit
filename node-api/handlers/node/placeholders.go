...
import "github.com/berachain/beacon-kit/node-api/engines/echo"

// Syncing is a placeholder so that beacon API clients don't break.
//
// TODO: Implement with real data.
func (h *Handler) Syncing(echo.Context) (any, error) {
...
//
// TODO: Implement with real data.
func (h *Handler) Version(echo.Context) (any, error) {
