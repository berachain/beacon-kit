...
// HasPendingBlobFetches provides a mock function with no fields
func (_m *ConsensusService) HasPendingBlobFetches() bool {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for HasPendingBlobFetches")
	}
...
// ConsensusService_HasPendingBlobFetches_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'HasPendingBlobFetches'
type ConsensusService_HasPendingBlobFetches_Call struct {
	*mock.Call
}

// HasPendingBlobFetches is a helper method to define mock.On call
func (_e *ConsensusService_Expecter) HasPendingBlobFetches() *ConsensusService_HasPendingBlobFetches_Call {
	return &ConsensusService_HasPendingBlobFetches_Call{Call: _e.mock.On("HasPendingBlobFetches")}
}

func (_c *ConsensusService_HasPendingBlobFetches_Call) Run(run func()) *ConsensusService_HasPendingBlobFetches_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *ConsensusService_HasPendingBlobFetches_Call) Return(_a0 bool) *ConsensusService_HasPendingBlobFetches_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ConsensusService_HasPendingBlobFetches_Call) RunAndReturn(run func() bool) *ConsensusService_HasPendingBlobFetches_Call {
	_c.Call.Return(run)
	return _c
}
