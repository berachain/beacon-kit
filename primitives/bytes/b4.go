...
// NOTE: IsLessThan and IsGreaterThan are not implemented to avoid opinionating a
// canonical sorting algorithm for B4, the 4-byte vector. A standard cmp function
// would require IsLessThan and IsGreaterThan and behave something like this:
//
//	func cmp(a, b B4) int {
//		if a.IsLessThan(b) {
//			return -1
...
// IsLessThanOrEqualTo returns true if h is less than or equal to b. This compares bytes from
// most significant to least significant in little-endian order.
...
// IsGreaterThanOrEqualTo returns true if h is greater than or equal to b.
// This compares bytes from most significant to least significant in little-endian order.
