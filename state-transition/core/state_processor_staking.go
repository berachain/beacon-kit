...
func (sp *StateProcessor[
	_, _, BeaconStateT, _, DepositT, _, _, _, _, _, _, _, _, _, _,
]) processDeposit(
	st BeaconStateT,
	dep DepositT,
) error {
...
func (sp *StateProcessor[
	_, _, BeaconStateT, _, DepositT, _, _, _, _, _, ValidatorT, _, _, _, _,
]) applyDeposit(
	st BeaconStateT,
	dep DepositT,
) error {
...
func (sp *StateProcessor[
	_, _, BeaconStateT, _, DepositT, _, _, _, ForkDataT, _, _, _, _, _, _,
]) createValidator(
	st BeaconStateT,
	dep DepositT,
) error {
