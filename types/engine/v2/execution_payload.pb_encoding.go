...
// Hash: e44731358064ac1bc195c79ec9f740de4486f4661100b64678c33a62b22c95a6
package v2
...
// MarshalSSZ ssz marshals the ExecutionPayloadCapellaWithValue object
func (e *ExecutionPayloadCapellaWithValue) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(e)
}

// MarshalSSZTo ssz marshals the ExecutionPayloadCapellaWithValue object to a target array
func (e *ExecutionPayloadCapellaWithValue) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(8)
	...
	dst = ssz.WriteOffset(dst, offset)
	if e.Payload == nil {
		e.Payload = new(ExecutionPayloadCapella)
	}
...
// UnmarshalSSZ ssz unmarshals the ExecutionPayloadCapellaWithValue object
func (e *ExecutionPayloadCapellaWithValue) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 8 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the ExecutionPayloadCapellaWithValue object
func (e *ExecutionPayloadCapellaWithValue) SizeSSZ() (size int) {
	size = 8
...
// HashTreeRoot ssz hashes the ExecutionPayloadCapellaWithValue object
func (e *ExecutionPayloadCapellaWithValue) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(e)
}

// HashTreeRootWith ssz hashes the ExecutionPayloadCapellaWithValue object with a hasher
func (e *ExecutionPayloadCapellaWithValue) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
