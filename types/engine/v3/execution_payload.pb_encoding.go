...
// Hash: 0e04095d4653a8d9dfeb27de7d7fa3587b43aace4fb0cf0aadfb986bb7997df7
package v3
...
func (e *ExecutionPayloadDeneb) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	for ii := 0; ii < len(e.Withdrawals); ii++ {
		offset += 4
		offset += e.Withdrawals[ii].SizeSSZ()
	}
...
func (e *ExecutionPayloadDeneb) UnmarshalSSZ(buf []byte) error {
	...
	// Field (14) 'Withdrawals'
	{
		...
		err = ssz.UnmarshalDynamic(buf, num, func(indx int, buf []byte) (err error) {
			if e.Withdrawals[indx] == nil {
				e.Withdrawals[indx] = new(v1.Withdrawal)
			}
			if err = e.Withdrawals[indx].UnmarshalSSZ(buf); err != nil {
				return err
			}
			return nil
		})
...
// MarshalSSZ ssz marshals the ExecutionPayloadDenebWithValueAndBlobsBundle object
func (e *ExecutionPayloadDenebWithValueAndBlobsBundle) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(e)
}

// MarshalSSZTo ssz marshals the ExecutionPayloadDenebWithValueAndBlobsBundle object to a target array
func (e *ExecutionPayloadDenebWithValueAndBlobsBundle) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(13)
	...
	dst = ssz.MarshalBool(dst, e.ShouldOverrideBuilder)
...
// UnmarshalSSZ ssz unmarshals the ExecutionPayloadDenebWithValueAndBlobsBundle object
func (e *ExecutionPayloadDenebWithValueAndBlobsBundle) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 13 {
		return ssz.ErrSize
	...
	// Field (3) 'ShouldOverrideBuilder'
	e.ShouldOverrideBuilder = ssz.UnmarshalBool(buf[12:13])
	...
	// Field (1) 'Value'
	{
		...
		if cap(e.Value) == 0 {
			e.Value = make([]byte, 0, len(buf))
		}
		e.Value = append(e.Value, buf...)
	}
...
// SizeSSZ returns the ssz encoded size in bytes for the ExecutionPayloadDenebWithValueAndBlobsBundle object
func (e *ExecutionPayloadDenebWithValueAndBlobsBundle) SizeSSZ() (size int) {
	size = 13
...
// HashTreeRoot ssz hashes the ExecutionPayloadDenebWithValueAndBlobsBundle object
func (e *ExecutionPayloadDenebWithValueAndBlobsBundle) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(e)
}

// HashTreeRootWith ssz hashes the ExecutionPayloadDenebWithValueAndBlobsBundle object with a hasher
func (e *ExecutionPayloadDenebWithValueAndBlobsBundle) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
	...
	// Field (3) 'ShouldOverrideBuilder'
	hh.PutBool(e.ShouldOverrideBuilder)
